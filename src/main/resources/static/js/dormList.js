    ...
    layui.use('table', function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'dormNo', title: '宿舍楼编号'}
                , {field: 'dormName', title: '楼栋名称'}
        ...
        table.on('tool(visitorTable)', function (obj) {
            ...
            if (obj.event === 'editVisitor') {
                layer.open({
                    ...
                    shade: 0.8,
                    area: ['60%', '70%'],
                    content: '/dorm/toEditDorm?dormId=' + data.id
                });
            }
            ...
            if (obj.event === 'lookVisitor') {
                layer.open({
                    ...
                    shade: 0.8,
                    area: ['60%', '70%'],
                    content: '/dorm/lookDorm?dormId=' + data.id
                });
            }
            ...
            if (obj.event === 'delVisitor') {
                layer.confirm('您确定删除吗？', {
                    ...
                    $.post("/dorm/delDormById", {'dormId': data.id}, function (data) {
                        if (data.success) {
